...
interface IYieldSplitter {
    ...
    function redeemAllYieldOnBehalfOf(address recipient_)
        external
        returns (uint256);
    ...
    function redeemableBalance(uint256 depositId_)
        external
        view
        returns (uint256);

    function totalRedeemableBalance(address recipient_)
        external
        view
        returns (uint256);

    function getDepositorIds(address donor_)
        external
        view
 ...
 */
abstract contract YieldSplitter is IYieldSplitter {
    ...
    */
    function _deposit(address depositor_, uint256 amount_)
        internal
    ...
    */
    function _addToDeposit(
        ...
        if (depositInfo[id_].depositor != depositorAddress)
            revert YieldSplitter_NotYourDeposit();
    ...
    */
    function _withdrawAllPrincipal(uint256 id_, address depositorAddress)
        internal
    ...
    */
    function _redeemYield(uint256 id_)
        internal
        returns (uint256 amountRedeemed)
    {
        DepositInfo storage userDeposit = depositInfo[id_];

        amountRedeemed = _getOutstandingYield(
            userDeposit.principalAmount,
    ...
    */
    ...
    /**
        ...
        @param id_ Id of the deposit.
    */
    function redeemYieldOnBehalfOf(uint256 id_)
        external
        virtual
        returns (uint256)
    {}
    ...
    */
     ...
     */
    function _getOutstandingYield(uint256 principal_, uint256 agnosticAmount_)
        internal
        view
        returns (uint256)
    {
